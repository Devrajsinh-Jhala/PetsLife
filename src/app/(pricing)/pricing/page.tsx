...
const Pricing = (props: Props) => {
  return (
    <section className="px-10 my-10 w-full flex items-center justify-between">
      ...
      <div className="">
        <div className="bg-background text-foreground w-[450px] border border-foreground p-4 rounded-lg">
          ...
          <div className="flex items-center justify-center">
            <p className="my-10 text-5xl font-bold">₹100</p>
          </div>
      ...
      <div className="flex flex-col items-center space-y-5">
        <Card className="w-[450px]">
          <CardHeader>
            ...
            <CardDescription>
              Here are some of the benefits you get upon investing your valuable
              money.
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="w-[450px]">
          <CardHeader>
            ...
            <CardDescription>
              You can cancel your subscription anytime if you do not like our
              service.
            </CardDescription>
          </CardHeader>
        </Card>
